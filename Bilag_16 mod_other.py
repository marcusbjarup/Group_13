# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:08:46 2017
...
cl_weight = {0:1, 1:14.626262626262625} 

logreg6 = LogisticRegression(class_weight=cl_weight,solver='newton-cg')

# train the model using X_train_dtm
logreg6.fit(X_train, y_train)

# make class predictions for X_test_dtm
y_pred_class = logreg6.predict(X_test)
...
#%%
import pickle
with open('mod_other.pkl', 'wb') as fout:
    pickle.dump((logreg6), fout)