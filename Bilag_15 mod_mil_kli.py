# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:07:59 2017
...
cl_weight = {0:1, 1:19.122448979591837} #Rigtig god - god balance med relativt høj recall. se dit plot!

logreg5 = LogisticRegression(class_weight=cl_weight,solver='newton-cg')

# train the model using X_train_dtm
logreg5.fit(X_train, y_train)

# make class predictions for X_test_dtm
y_pred_class = logreg5.predict(X_test)
...
#%%
import pickle
with open('mod_mil_kli.pkl', 'wb') as fout:
    pickle.dump((logreg5), fout)