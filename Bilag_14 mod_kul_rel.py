# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:07:20 2017
...
logreg4 = MultinomialNB(alpha=0.12332653061224491, class_prior=None, fit_prior=True)

# train the model using X_train_dtm
logreg4.fit(X_train, y_train)

# make class predictions for X_test_dtm
y_pred_class = logreg4.predict(X_test)
...
#%%
import pickle
with open('mod_kul_rel.pkl', 'wb') as fout:
    pickle.dump((logreg4), fout)