# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:06:42 2017
...
cl_weight = {0:1, 1:5.9591836734693882} 

logreg3 = LogisticRegression(class_weight=cl_weight,solver='newton-cg')
...
#%%
import pickle
with open('mod_kon_kon.pkl', 'wb') as fout:
    pickle.dump((logreg3), fout)