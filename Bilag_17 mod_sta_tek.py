# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:09:50 2017
...
cl_weight = {1:1.153061224489796, 0:1} #noter at den har byttet om her!!!!

logreg7 = LogisticRegression(class_weight=cl_weight,solver='newton-cg')

# train the model using X_train_dtm
logreg7.fit(X_train, y_train)

# make class predictions for X_test_dtm
y_pred_class = logreg7.predict(X_test)
...
#%%
import pickle
with open('mod_sta_tek.pkl', 'wb') as fout:
    pickle.dump((logreg7), fout)